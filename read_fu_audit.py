...
df_fu_audit.loc[df_fu_audit['Was a call successfully ?'].str.contains('Yes'), 'Was a call successfully -new'] = 'Yes'
df_fu_audit.loc[df_fu_audit['FOLLOWUP - Have you visited a healthcare provider since discharge?'].str.contains('Yes'), 'FOLLOWUP - Have you visited a healthcare provider since discharg-new'] = 'Yes'
df_fu_audit.loc[df_fu_audit['FOLLOWUP - If yes, did you go to that visit?'].str.contains('Yes'), 'FOLLOWUP - If yes, did you go to that visit?-new'] = 'No'
